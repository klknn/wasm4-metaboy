...
window.addEventListener('DOMContentLoaded', () => {
    setTimeout(async () => {
        ...
        // Auto-fetch ROM: URL query ?rom=..., or default to Tobu Tobu Girl (with full sound & music)
        ...
        if (queryRom && queryRom !== 'debug' && queryRom !== 'none') {
            ...
            // Load Tobu Tobu Girl by default
            await fetchAndLoad('tobutobugirl', 'Tobu Tobu Girl');
        }
